 ...
 */
public final class GooglePlayGamesParser implements Parser {
    ...
    public String parseRating(Document document) {
        return document.getElementsByAttributeValueStarting(
                "aria-label", "Средняя оценка").attr("aria-label");
